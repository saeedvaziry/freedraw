...
return [
    ...
    'info' => [
         ...
         */
        'description' => 'FreeDraw JSON endpoints used by the authenticated board experience.',
    ],

    'access_emails' => array_filter(array_map('trim', explode(',', (string) env('API_DOCS_EMAILS', '')))),
